...
if (global.command === 'equip') {
    ...
    const headers = [
        ...
        { id: 'damageBase', title: global.options.readable ? '武器伤害基础' : 'damageBase'}, 
        { id: 'damageRange', title: global.options.readable ? '武器伤害范围' : 'damageRange'}, 
        { id: 'attackSpeed', title: global.options.readable ? '武器攻击速度' : 'attackSpeed'}, 
